const assessment = {
    ...
    levels: [
        { range: [0, 9], label: "Normal", class: "normal" },
        { range: [10, 13], label: "Mild", class: "mild" },
        { range: [14, 20], label: "Moderate", class: "moderate" },
        { range: [21, 27], label: "Severe", class: "severe" },
        { range: [28, 42], label: "Extremely Severe", class: "extreme" }
    ],
};
let currentState = {
    currentQuestion: 0,
