const assessment = {
    ...
    questions: [
        ...
        "I was worried about situations where I might panic and make a fool of myself",
        "I felt I was close to panic",
        "I was aware of my heart action without physical exertion (e.g., heart racing, skipped beats)",
        "I felt scared without any good reason"
    ],
    levels: [
        { range: [0, 7], label: "Normal", class: "normal" },
        { range: [8, 9], label: "Mild", class: "mild" },
        { range: [10, 14], label: "Moderate", class: "moderate" },
        { range: [15, 19], label: "Severe", class: "severe" },
        { range: [20, 42], label: "Extremely Severe", class: "extreme" }
    ],
};
